...
const Meta = (props: IMetaProps) => {
	...
	const title = props?.title || "CFD MOV";
	...
	return (
		<>
			<Head>
				...
				<link rel="shortcut icon" href={`${router.basePath}/favicon.png`} />

				<link rel="shortcut icon" type="image/png" sizes="32x32" href={`${router.basePath}/favicon.png`} />
				<link rel="shortcut icon" type="image/png" sizes="16x16" href={`${router.basePath}/favicon.png`} />
