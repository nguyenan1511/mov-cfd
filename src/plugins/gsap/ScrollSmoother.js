	...
	function ScrollSmoother(t) {
		...
		function Ta(e) {
			return arguments.length
				? (e < 0 && (e = 0), (O.y = -e), (h = !0), f ? (H = -e) : Sa(-e), $.isRefreshing ? i.update() : E(e / A), this)
				: -H;
		}
		function Wa(e) {
			(w.scrollTop = 0),
				(e.target.contains && e.target.contains(w)) ||
					(T && !1 === T(o, e)) ||
					($.isInViewport(e.target) || e.target === g || o.scrollTo(e.target, !1, "center center"), (g = e.target));
		}
		function Xa(t, e) {
					...
					for (c = 0; c < t.length; c++)
						if (
							...
							if (((n = f.end - f.start), (o = e._startClamp && f.start < 0))) {
								if (0 < e.start)
									return e.setPositions(0, e.end + (e._startNative - e.start), !0), void adjustEffectRelatedTriggers(e, t);
								(n += f.start), (u.offset = -f.start);
							}
							u.push({ start: f.start, nativeStart: s, end: f.end, distance: n, trig: f }),
					...
					S.forEach(function (e) {
						...
						e._startClamp && t < 0
							...
							: (e.ratio < 0 || (e._endClamp && r >= C())) &&
							  (n = ((r = C()) - (t = e.ratio < 0 || 1 < e.ratio ? 0 : r - (r - e.start) / e.ratio)) * e.ratio - (e.end - e.start)),
							(e.offset = n || 1e-4),
							...
							0 < c &&
								((n =
									0.5 == (r = a.height / (I.innerHeight + a.height))
										? 2 * a.height
										: 2 * Math.min(a.height, Math.abs((-c * r) / (2 * r - 1))) * (t || 1)),
								(f += t ? -n * t : -n / 2),
								(c += n)),
							{ change: c, offset: f }
						);
		...
		_a(),
			...
			(this.offset = function (e, t) {
				...
				return (
					S && (M ? $.refresh() : Za([o], !0)), (r = o.start / A), o.kill(!1), (e.style.cssText = n), (F.core.getCache(e).uncache = 1), r
				);
			}),
